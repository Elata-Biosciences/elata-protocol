...
/**
 * @title VeELTAMultiLock
 * @author Elata Biosciences
 * @notice Advanced ve-style staking with multiple non-transferable lock positions
 ...
 */
contract VeELTAMultiLock is ERC721, ERC721Enumerable, ReentrancyGuard, AccessControl {
    ...
    constructor(
        IERC20 _elta,
        address _admin
    ) ERC721("Vote-Escrowed ELTA Multi-Lock", "veELTA-ML") {
