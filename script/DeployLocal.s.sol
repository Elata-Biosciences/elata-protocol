...
contract DeployLocal is Script {
    function run() external {
        ...
        console.log(
            "NEXT_PUBLIC_ELTA_ADDRESS_LOCALHOST=%s",
            address(elta)
        );
        // console.log("NEXT_PUBLIC_APP_FACTORY_ADDRESS_LOCALHOST=%s", address(appFactory));
        console.log(
            "NEXT_PUBLIC_UNISWAP_ROUTER_ADDRESS_LOCALHOST=%s",
            address(uniRouter)
        );
        console.log(
