...
contract SeedLocalData is Script {
    ...
    address constant ELTA_ADDRESS =
        0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512;
    address constant XP_ADDRESS =
        0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0;
    address constant STAKING_ADDRESS =
        0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9;
    address constant FUNDING_ADDRESS =
        0x0165878A594ca255338adfa4d48449f69242Eb8F;
    address constant
        APP_FACTORY_ADDRESS =
            0x610178dA211FEF7D417bC0e6FeD39F05609AD788;
    address constant
        APP_MODULE_FACTORY_ADDRESS =
    ...
    function run() external {
        ...
        console2.log(
            "       SEEDING LOCAL BLOCKCHAIN WITH DATA"
        );
        console2.log(
            "=================================================\n"
        );
        ...
        console2.log(
            "[1/5] Awarding XP to test users..."
        );
        _awardTestXP();

        // Step 2: Create staking positions
        console2.log(
            "[2/5] Creating test staking positions..."
        );
        _createStakingPositions();

        // Step 3: Create test apps
        console2.log(
            "[3/5] Creating test apps..."
        );
        TestApp[] memory apps =
            _createTestApps();
        ...
        console2.log(
            "[4/5] Configuring app economies..."
        );
        _configureAppEconomies(apps);

        // Step 5: Start a funding round
        console2.log(
            "[5/5] Starting initial funding round..."
        );
        _startFundingRound();
    ...
    function _createStakingPositions()
        internal
    {
        ELTA elta = ELTA(ELTA_ADDRESS);
        VeELTA staking =
            VeELTA(STAKING_ADDRESS);
    ...
    function _createTestApps()
        internal
        returns (TestApp[] memory)
    {
        ELTA elta = ELTA(ELTA_ADDRESS);
        ...
        returns (TestApp memory app)
    {
        ...
        console2.log(
            "       Deployed modules: Access, Staking, Rewards"
        );
    ...
    function _configureSingleApp(
        ...
        console2.log(
            "       Configured feature gate for",
            app.name
        );
    }

    function _startFundingRound()
        internal
    {
        LotPool funding =
            LotPool(FUNDING_ADDRESS);
        ELTA elta = ELTA(ELTA_ADDRESS);
        ...
        address[] memory recipients =
            new address[](3);
        recipients[0] =
            0x70997970C51812dc3A010C7d01b50e0d17dc79C8; // Test recipient 1
        recipients[1] =
            0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC; // Test recipient 2
        recipients[2] =
            0x90F79bf6EB2c4f870365E785982E1f101E93b906; // Test recipient 3

        // Start 7-day round
        (uint256 roundId,) = funding
            .startRound(
            options, recipients, 7 days
        );

        console2.log(
            "       Started funding round #",
            roundId
        );
        console2.log(
            "       Options: PTSD Research, Depression Study, Focus Enhancement"
        );
        console2.log(
            "       Duration: 7 days"
        );
    ...
    function _printSeedSummary(
        ...
        console2.log("--------");
        console2.log(
            "- 5 test users with XP (300-5000 XP)"
        );
        console2.log(
            "- 3 staking positions (2.5K-10K ELTA)"
        );
        console2.log(
            "- 3 test apps with full economies:"
        );
        ...
        console2.log(
            "- 1 active funding round with 3 options"
        );
        console2.log("");
        console2.log(
            "Ready for development! Start the frontend:"
        );
        console2.log(
