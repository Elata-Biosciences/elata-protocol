 ...
 */
contract AppAccess1155SecurityTest is
    Test
{
    ...
    function test_Security_ReentrancyProtection_Purchase(
    ) public {
        // Configure item
        vm.prank(owner);
        access.setItem(
        ...
        ReentrancyAttacker
            attackContract = new ReentrancyAttacker(
                access, appToken
            );
    ...
    function test_Security_NoOverflow_PriceCalculation(
    ) public {
        // Set max price
        vm.prank(owner);
        access.setItem(
        ...
        access.purchase(
            1, 2, bytes32(0)
        ); // Would overflow if not protected
        vm.stopPrank();
    }

    function test_Security_NoUnderflow_SupplyTracking(
    ) public {
    ...
    function test_Security_OnlyOwnerCanSetItem(
    ) public {
        vm.expectRevert();
        vm.prank(attacker);
        access.setItem(
    ...
    function test_Security_OnlyOwnerCanToggleSoulbound(
    ) public {
        vm.prank(owner);
        access.setItem(
            1,
    ...
    function test_Security_OnlyOwnerCanSetFeatureGate(
    ) public {
        vm.expectRevert();
        vm.prank(attacker);
    ...
    function test_Security_SoulboundCannotBeTransferred(
    ) public {
    ...
    function test_Security_SoulboundCannotBeBatchTransferred(
    ) public {
        // Configure soulbound item
        vm.prank(owner);
        access.setItem(
    ...
    function test_Security_CanToggleSoulboundAfterMint(
    ) public {
    ...
    function test_Security_PurchaseActuallyBurns(
    ) public {
        vm.prank(owner);
        access.setItem(
            1,
    ...
    function test_Security_CannotPurchaseWithoutApproval(
    ) public {
        vm.prank(owner);
        access.setItem(
            1,
    ...
    function test_Security_CannotPurchaseBeforeStart(
    ) public {
    ...
    function test_Security_CannotPurchaseAfterEnd(
    ) public {
    ...
    function test_Security_TimeWindowEdgeCases(
    ) public {
        uint64 startTime = uint64(
            block.timestamp + 100
        );
    ...
    function test_Security_SupplyCapEnforced(
    ) public {
        vm.prank(owner);
        access.setItem(
            1,
    ...
    function test_Security_SupplyCapRaceCondition(
    ) public {
    ...
    function test_Security_ZeroPriceItem(
    ) public {
        vm.prank(owner);
        access.setItem(
            1,
        ...
        assertEq(
            access.balanceOf(user1, 1),
            1
        );
    }

    function test_Security_InactiveItemCannotBePurchased(
    ) public {
        vm.prank(owner);
        access.setItem(
            1,
    ...
    function test_Security_CanDeactivateAndReactivate(
    ) public {
        vm.startPrank(owner);
        access.setItem(
            1,
