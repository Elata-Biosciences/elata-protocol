 ...
 */
contract AppStakingVaultSecurityTest is
    Test
{
    ...
    function test_Security_ReentrancyProtection_Stake(
    ) public {
    ...
    function test_Security_ReentrancyProtection_Unstake(
    ) public {
    ...
    function test_Security_TotalStakedAccurate(
    ) public {
    ...
    function test_Security_BalanceMatchesTotalStaked(
    ) public {
        vm.prank(user1);
        appToken.approve(
            address(vault), 1000 ether
    ...
    function test_Security_CannotUnstakeMoreThanStaked(
    ) public {
        vm.prank(user1);
        appToken.approve(
            address(vault), 1000 ether
    ...
    function test_Security_StakeUnstakeCycle(
    ) public {
    ...
    function test_Security_CannotStakeZero(
    ) public {
        vm.expectRevert(
            Errors
                .InvalidAmount
    ...
    function test_Security_CannotUnstakeZero(
    ) public {
        vm.expectRevert(
            Errors
                .InvalidAmount
    ...
    function testFuzz_Security_MultipleUsers(
        ...
        user1Amount = bound(
            user1Amount, 1, 10000 ether
        );
        user2Amount = bound(
            user2Amount, 1, 10000 ether
        );

        // Both users stake
        vm.prank(user1);
        appToken.approve(
            address(vault), user1Amount
        );
        vm.prank(user1);
    ...
    function test_Security_CannotGriefVault(
    ) public {
    ...
    function test_Security_EmergencyUnstake(
    ) public {
...
contract MaliciousReceiver {
    ...
    function doStake(uint256 amount)
        external
    {
        token.approve(
