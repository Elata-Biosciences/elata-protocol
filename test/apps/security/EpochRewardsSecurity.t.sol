 ...
 */
contract EpochRewardsSecurityTest is
    Test
{
    ...
    function test_Security_EpochsAreIsolated(
    ) public {
        // Create two epochs
        vm.startPrank(owner);
    ...
    function test_Security_CannotClaimFromWrongEpoch(
    ) public {
        // Setup two epochs
        vm.startPrank(owner);
        rewards.startEpoch(
    ...
    function test_Security_CannotReuseClaimAcrossEpochs(
    ) public {
    ...
    function test_Security_CannotClaimWithWrongProof(
    ) public {
        vm.startPrank(owner);
        rewards.startEpoch(
            0,
        ...
        vm.prank(attacker);
        rewards.claim(
            1, fakeProof, 5000 ether
        );
    }

    function test_Security_CannotClaimDifferentAmount(
    ) public {
        vm.startPrank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_Security_CannotClaimOthersReward(
    ) public {
        vm.startPrank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_Security_OnlyOwnerCanStartEpoch(
    ) public {
        vm.expectRevert();
        vm.prank(attacker);
        rewards.startEpoch(
    ...
    function test_Security_OnlyOwnerCanFund(
    ) public {
        vm.prank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_Security_OnlyOwnerCanFinalize(
    ) public {
        vm.prank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_Security_CannotFinalizeMultipleTimes(
    ) public {
        vm.startPrank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_Security_CannotClaimBeforeFinalize(
    ) public {
        vm.prank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_Security_TotalClaimedTrackedCorrectly(
    ) public {
        vm.startPrank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_Security_FundingAccumulatesCorrectly(
    ) public {
        vm.startPrank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_Security_ViewFunctionsNoSideEffects(
    ) public {
        vm.prank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_Security_UtilizationCalculation(
    ) public {
        vm.startPrank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_Security_CannotStartEpochWithInvalidWindow(
    ) public {
        vm.expectRevert(
            EpochRewards
                .InvalidWindow
    ...
    function test_Security_CannotFundWithoutEpoch(
    ) public {
        vm.expectRevert(
            EpochRewards
                .NoActiveEpoch
    ...
    function test_Security_CannotFinalizeWithoutEpoch(
    ) public {
        vm.expectRevert(
            EpochRewards
                .NoActiveEpoch
    ...
    function test_Security_CannotClaimNonexistentEpoch(
    ) public {
        bytes32[] memory proof =
            new bytes32[](0);
    ...
    function test_Security_CannotClaimTwiceSameEpoch(
    ) public {
        vm.startPrank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_Security_ReentrancyProtection_Claim(
    ) public {
        vm.startPrank(owner);
        rewards.startEpoch(
            0,
        ...
        assertTrue(
            rewards.claimed(1, user1)
        );
        (,,,, uint256 totalClaimed) =
            rewards.epochs(1);
        assertEq(
            totalClaimed, 3000 ether
        );
    }
    ...
    function test_Security_MultipleFundingCallsAccumulate(
    ) public {
        vm.startPrank(owner);
        rewards.startEpoch(
            0,
    ...
    function testFuzz_Security_ClaimAmountLimited(
        ...
        appToken.approve(
            address(rewards),
            60000 ether
        ); // Increased to cover max claim + fees
    ...
    function test_Security_BatchViewsEfficient(
    ) public {
        // Create 3 epochs
        vm.startPrank(owner);
        ...
        bool[] memory statuses = rewards
            .checkClaimStatuses(1, users);
