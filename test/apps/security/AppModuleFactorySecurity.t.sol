 ...
 */
contract AppModuleFactorySecurityTest is
    Test
{
    ...
    function test_Security_OnlyTokenOwnerCanDeploy(
    ) public {
        vm.expectRevert(
            AppModuleFactory
                .NotTokenOwner
    ...
    function test_Security_OnlyFactoryOwnerCanSetTreasury(
    ) public {
        vm.expectRevert();
        vm.prank(attacker);
    ...
    function test_Security_OnlyFactoryOwnerCanSetFee(
    ) public {
        vm.expectRevert();
        vm.prank(attacker);
    ...
    function test_Security_CannotDeployModulesTwice(
    ) public {
        vm.prank(appCreator);
        factory.deployModules(
            address(appToken),
    ...
    function test_Security_DeployedModulesHaveCorrectOwner(
    ) public {
        vm.prank(appCreator);
        (address access, address vault,)
        = factory.deployModules(
            address(appToken),
            "https://test/"
        );
        ...
        assertEq(
            AppAccess1155(access).owner(
            ),
            appCreator
        );
        assertEq(
            AppStakingVault(vault).owner(
            ),
            appCreator
        );
    }

    function test_Security_DeployedModulesLinkedCorrectly(
    ) public {
        vm.prank(appCreator);
        (address access, address vault,)
        = factory.deployModules(
    ...
    function test_Security_ELTAFeeCollectedCorrectly(
    ) public {
    ...
    function test_Security_CannotDeployWithoutELTAApproval(
    ) public {
        vm.prank(factoryOwner);
    ...
    function test_Security_DeployWorksWithZeroFee(
    ) public {
        // Fee is 0 by default
        assertEq(
    ...
    function test_Security_DeployWorksWithELTADisabled(
    ) public {
    ...
    function test_Security_RegistryMappingCorrect(
    ) public {
        vm.prank(appCreator);
        (
            address access,
    ...
    function test_Security_MultipleAppsIsolated(
    ) public {
    ...
    function test_Security_CannotChangeTreasuryToZero(
    ) public {
        vm.prank(factoryOwner);
    ...
    function test_Security_TreasuryChangeDoesNotAffectPastDeployments(
    ) public {
        vm.prank(factoryOwner);
        factory.setCreateFee(50 ether);
    ...
    function test_Security_DeployedContractsAreValid(
    ) public {
        vm.prank(appCreator);
        (address access, address vault,)
        = factory.deployModules(
    ...
    function test_Security_CannotDeployForFakeToken(
    ) public {
