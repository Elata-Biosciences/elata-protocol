 ...
 */
contract
    XPGatedLaunchAndTransferFeesTest is
    Test
{
    ELTA public elta;
    ElataXP public xp;
    ...
    address public creator =
        makeAddr("creator");
    address public xpUser =
        makeAddr("xpUser");
    address public noXpUser =
        makeAddr("noXpUser");
    address public staker1 =
        makeAddr("staker1");
    address public staker2 =
        makeAddr("staker2");
    address public veHolder =
        makeAddr("veHolder");
    ...
    event XPGateUpdated(
        uint256 minXP, uint256 duration
    );
    event TransferFeeUpdated(
        uint16 oldBps, uint16 newBps
    );
    event TransferFeeExemptSet(
    ...
    function setUp() public {
        ...
        appRewardsDistributor.grantRole(
            appRewardsDistributor
                .FACTORY_ROLE(),
            address(factory)
        );
        ...
        elta.transfer(
            creator, 10_000 ether
        );
        elta.transfer(
            xpUser, 10_000 ether
        );
        elta.transfer(
            noXpUser, 10_000 ether
        );
        elta.transfer(
            staker1, 50_000 ether
        );
        elta.transfer(
            staker2, 50_000 ether
        );
        elta.transfer(
            veHolder, 100_000 ether
        );
        vm.stopPrank();
    ...
    function test_XPGate_UserWithXPCanBuyDuringEarlyAccess(
    ) public {
        // Create app
        ...
        assertTrue(
            curve.canUserBuy(xpUser)
        );
    }

    function test_XPGate_UserWithoutXPCannotBuyDuringEarlyAccess(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
        ...
        assertFalse(
            curve.canUserBuy(noXpUser)
        );
    }

    function test_XPGate_AllUsersCanBuyAfterEarlyAccessEnds(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
    ...
    function test_XPGate_GovernanceCanUpdateParameters(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
    ...
    function test_XPGate_NonGovernanceCannotUpdateParameters(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
    ...
    function test_FoT_TransferFeeAppliedCorrectly(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
    ...
    function test_FoT_FeesSplitCorrectly(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
        ...
        uint256 appRewardsBefore =
            token.balanceOf(appRewards);
        uint256 veRewardsBefore =
            token.balanceOf(veRewards);
        uint256 treasuryBefore = token
    ...
    function test_FoT_ExemptAddressesSkipFee(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
    ...
    function test_FoT_GovernanceCanUpdateFee(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
    ...
    function test_FoT_CannotExceedMaxFee(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
        ...
        vm.prank(governance);
        vm.expectRevert(
            AppToken.FeeTooHigh.selector
        );
        token.setTransferFeeBps(201);
    }

    function test_FoT_GovernanceCanSetExemptions(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
    ...
    function test_Views_GetTransferFeeInfo(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
    ...
    function test_Views_CalculateTransferFee(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
    ...
    function test_Views_GetAppLaunchStatus(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
    ...
    function test_Views_CanUserBuy()
        public
    {
        // Create app
        uint256 totalCost = factory
    ...
    function test_Views_GetEarlyAccessInfo(
    ) public {
        // Create app
        uint256 totalCost = factory
            .creationFee()
