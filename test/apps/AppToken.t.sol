...
contract AppTokenTest is Test {
    ...
    function test_RevertWhen_DeploymentInvalidSupply(
    ) public {
        vm.expectRevert(
            "Invalid supply"
        );
    ...
    function test_RevertWhen_MintUnauthorized(
    ) public {
        vm.expectRevert();
        vm.prank(user1);
    ...
    function test_RevertWhen_MintExceedsSupply(
    ) public {
        vm.expectRevert(
            AppToken
                .SupplyCapExceeded
    ...
    function test_MintUpToSupplyCap()
        public
    {
        vm.prank(admin);
    ...
    function test_UpdateMetadata()
        public
    {
        string memory description =
            "Revolutionary EEG game";
        ...
        assertEq(
            token.appWebsite(), website
        );
    }

    function test_RevertWhen_UpdateMetadataUnauthorized(
    ) public {
        vm.expectRevert(
            AppToken
                .OnlyCreator
    ...
    function test_MinterRoleManagement()
        public
    {
    ...
    function test_StandardERC20Functions(
    ) public {
    ...
    function test_RevertWhen_MintAfterFinalize(
    ) public {
        vm.prank(admin);
        token.finalizeMinting();
    ...
    function test_RevertWhen_FinalizeMintingUnauthorized(
    ) public {
        vm.expectRevert();
        vm.prank(user1);
        token.finalizeMinting();
    ...
    function test_MintBeforeFinalize()
        public
    {
    ...
    function test_PermitFunctionality()
        public
    {
