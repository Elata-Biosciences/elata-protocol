...
contract AppAccess1155Test is Test {
    ...
    uint256 public constant ITEM_PRICE =
        100 ether;
    ...
    event FeatureGateSet(
        ...
        AppAccess1155.FeatureGate gate
    );
    ...
    function test_RevertWhen_SetItemUnauthorized(
    ) public {
        vm.expectRevert();
        vm.prank(user1);
        access.setItem(
    ...
    function test_RevertWhen_PurchaseInactiveItem(
    ) public {
        vm.prank(owner);
        access.setItem(
            1,
    ...
    function test_RevertWhen_PurchaseTooEarly(
    ) public {
    ...
    function test_RevertWhen_PurchaseTooLate(
    ) public {
    ...
    function test_RevertWhen_PurchaseExceedsSupply(
    ) public {
        vm.prank(owner);
        access.setItem(
            1,
    ...
    function test_PurchaseUpToMaxSupply(
    ) public {
        vm.prank(owner);
        access.setItem(
            1,
    ...
    function test_SoulboundTransferBlocked(
    ) public {
    ...
    function test_TransferableItemCanMove(
    ) public {
    ...
    function test_SetFeatureGate()
        public
    {
        bytes32 featureId =
            keccak256("premium_mode");

        AppAccess1155.FeatureGate memory
            gate = AppAccess1155
                .FeatureGate({
                minStake: 1000 ether,
                requiredItem: 1,
    ...
    function test_RevertWhen_SetFeatureGateUnauthorized(
    ) public {
        bytes32 featureId =
            keccak256("premium_mode");
    ...
    function test_URIFallsBackToBase()
        public
    {
        vm.prank(owner);
        access.setItem(
