...
contract AppStakingVaultTest is Test {
    ...
    function test_StakeMultipleTimes()
        public
    {
        vm.startPrank(user1);
    ...
    function test_StakeFromMultipleUsers(
    ) public {
        // User1 stakes
        vm.startPrank(user1);
        appToken.approve(
    ...
    function test_RevertWhen_StakeZero()
        public
    {
        vm.expectRevert(
            Errors
    ...
    function test_RevertWhen_StakeWithoutApproval(
    ) public {
        vm.expectRevert();
        vm.prank(user1);
        vault.stake(1000 ether);
    ...
    function test_RevertWhen_UnstakeZero(
    ) public {
        vm.expectRevert(
            Errors
                .InvalidAmount
    ...
    function test_RevertWhen_UnstakeMoreThanStaked(
    ) public {
        // Stake 1000
        vm.startPrank(user1);
        appToken.approve(
    ...
    function test_RevertWhen_UnstakeWithNoStake(
    ) public {
        vm.expectRevert(
            AppStakingVault
                .Insufficient
    ...
    function test_StakeUnstakeSequence()
        public
    {
        vm.startPrank(user1);
