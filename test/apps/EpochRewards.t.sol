...
contract EpochRewardsTest is Test {
    ...
    function test_RevertWhen_StartEpochInvalidWindow(
    ) public {
        vm.expectRevert(
            EpochRewards
                .InvalidWindow
    ...
    function test_RevertWhen_StartEpochUnauthorized(
    ) public {
        vm.expectRevert();
        vm.prank(user1);
        rewards.startEpoch(
    ...
    function test_FundMultipleTimes()
        public
    {
        vm.prank(owner);
        rewards.startEpoch(
        ...
        (,,, uint256 totalFunded,) =
            rewards.epochs(1);
        assertEq(
            totalFunded, 15000 ether
        );
    }

    function test_RevertWhen_FundWithoutEpoch(
    ) public {
        vm.expectRevert(
            EpochRewards
                .NoActiveEpoch
    ...
    function test_RevertWhen_FundUnauthorized(
    ) public {
        vm.prank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_RevertWhen_FinalizeEpochWithoutEpoch(
    ) public {
        vm.expectRevert(
            EpochRewards
                .NoActiveEpoch
    ...
    function test_RevertWhen_FinalizeEpochTwice(
    ) public {
        vm.startPrank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_RevertWhen_FinalizeEpochUnauthorized(
    ) public {
        vm.prank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_Claim() public {
        ...
        (,,,, uint256 totalClaimed) =
            rewards.epochs(1);
        assertEq(
            totalClaimed, user1Reward
        );
    }

    function test_MultipleUsersClaim()
        public
    {
        ...
        assertEq(
            appToken.balanceOf(user2),
            2970 ether
        ); // 3000 * 0.99
        assertEq(
            appToken.balanceOf(user3),
            1980 ether
        ); // 2000 * 0.99
        ...
        (,,,, uint256 totalClaimed) =
            rewards.epochs(1);
        assertEq(
            totalClaimed, 10000 ether
        );
    }

    function test_RevertWhen_ClaimNotFinalized(
    ) public {
        vm.prank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_RevertWhen_ClaimInvalidProof(
    ) public {
        vm.startPrank(owner);
        rewards.startEpoch(
            0,
    ...
    function test_MultipleEpochsIsolation(
    ) public {
