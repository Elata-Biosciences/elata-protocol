...
contract ProtocolTest is Test {
    ...
    address public researcher1 =
        makeAddr("researcher1");
    address public researcher2 =
        makeAddr("researcher2");

    uint256 public constant
        TOTAL_SUPPLY = 77_000_000 ether;
    uint256 public constant
        INITIAL_MINT = 10_000_000 ether;
    ...
    function setUp() public {
        ...
        governor =
            new ElataGovernor(elta);

        // Distribute tokens for testing (treasury has 10M, distribute 8M)
        vm.startPrank(treasury);
        elta.transfer(
            alice, 4_000_000 ether
        );
        elta.transfer(
            bob, 2_500_000 ether
        );
        elta.transfer(
            charlie, 1_500_000 ether
        );
        vm.stopPrank();
    ...
    function test_CompleteProtocolWorkflow(
    ) public {
        ...
        internal
    {
        ...
        assertGt(
            staking.balanceOf(alice), 0
        ); // Has veELTA voting power
        ...
        internal
    {
        ...
        // Verify payout
        assertEq(
            elta.balanceOf(researcher1),
            50_000 ether
        );
    }

    function _testRewardsWorkflow()
        internal
    {
    ...
    function _testGovernanceWorkflow()
        internal
    {
    ...
    function test_SystemCompatibility()
        public
    {
        ...
        assertGt(
            elta.getVotes(alice), 0
        ); // Governance voting power
    }

    function test_AccessControl()
        public
    {
    ...
    function test_TokenTransferability()
        public
    {
