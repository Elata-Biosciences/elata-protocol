 ...
 */
contract RewardsDistributorTest is
    Test
{
    ...
    function test_Deposit_70_15_15_Split(
    ) public {
        ...
        public
    {
        ...
        vm.prank(admin);
        rewardsDistributor.setTreasury(
            newTreasury
        );
