...
contract ELTATest is Test {
    ...
    function test_RevertWhen_MintToZeroAddress(
    ) public {
        vm.expectRevert(
            Errors.ZeroAddress.selector
        );
    ...
    function test_RevertWhen_MintExceedsCap(
    ) public {
        vm.startPrank(admin);
