...
contract AppRewardsDistributorTest is
    Test
{
    ELTA public elta;
    ...
    function setUp() public {
        ...
        // Deploy distributor
        distributor = new AppRewardsDistributor(
        ...
        vault2 = new AppStakingVault(
            "Game2", "GM2", token2, bob
        );
        token2.mint(
            address(this),
            1_000_000 ether
        ...
        token1.setTransferFeeExempt(
            address(vault1), true
        );
        token2.setTransferFeeExempt(
            address(vault2), true
        );
    ...
    {
        assertEq(
            address(distributor.ELTA()),
            address(elta)
        );
        assertEq(
            distributor.getVaultCount(),
            0
        );
    }
        ...
        public
    {
        ...
        assertEq(
            distributor.vaults(0),
            address(vault1)
        );
    }

    function test_RegisterApp_RevertIfNotFactory(
    ) public {
        vm.prank(alice);
        vm.expectRevert();
        distributor.registerApp(
    ...
    function test_RegisterApp_RevertIfExists(
    ) public {
        vm.prank(factory);
        distributor.registerApp(
            address(vault1)
    ...
    function test_Distribute_SingleVault(
    ) public {
        // Register vault
        vm.prank(factory);
        distributor.registerApp(
    ...
    function test_Distribute_MultipleVaults_EqualStakes(
    ) public {
        // Register vaults
        vm.prank(factory);
        distributor.registerApp(
    ...
    function test_Distribute_MultipleVaults_UnequalStakes(
    ) public {
        // Register vaults
        vm.prank(factory);
        distributor.registerApp(
    ...
    function test_Distribute_SkipsPausedVaults(
    ) public {
        // Register vaults
        vm.prank(factory);
        distributor.registerApp(
    ...
    function test_Distribute_ZeroStake()
        public
    {
        // Register vault
        vm.prank(factory);
    ...
    function test_Claim_SingleEpoch()
        public
    {
        ...
        assertEq(
            distributor.userCursor(
                alice, address(vault1)
            ),
            1
        );
    }

    function test_Claim_MultipleUsers()
        public
    {
        vm.roll(100);
    ...
    function test_Claim_MultipleEpochs()
        public
    {
        vm.roll(100);
    ...
    function test_Claim_GasBounded()
        public
    {
        vm.roll(100);
    ...
    function test_Claim_SkipsEpochsWithZeroStake(
    ) public {
        vm.roll(100);
        ...
        public
    {
        ...
        uint256[] memory toEpochs =
            new uint256[](2);
        toEpochs[0] = 1;
        toEpochs[1] = 1;

        vm.prank(alice);
        distributor.claimMultiple(
            vaults, toEpochs
        );
    ...
    function test_EstimatePendingRewards(
    ) public {
        vm.roll(100);
        ...
        uint256 bobPending = distributor
            .estimatePendingRewards(
            bob, address(vault1)
        );
    ...
    function test_GetUnclaimedRange()
        public
    {
        vm.prank(factory);
        distributor.registerApp(
