        ...
        <section className="py-12 sm:py-20 px-4 sm:px-6 bg-cream2">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:scale-105 hover:-translate-y-3 transition-all duration-500">
                ...
                <h3 className="font-montserrat font-semibold text-offBlack mb-3 text-center text-lg">App Launches</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:scale-105 hover:-translate-y-3 transition-all duration-500">
                ...
                <h3 className="font-montserrat font-semibold text-offBlack mb-3 text-center text-lg">ELTA Staking</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:scale-105 hover:-translate-y-3 transition-all duration-500">
                ...
                <h3 className="font-montserrat font-semibold text-offBlack mb-3 text-center text-lg">Governance</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:scale-105 hover:-translate-y-3 transition-all duration-500">
                ...
                <h3 className="font-montserrat font-semibold text-offBlack mb-3 text-center text-lg">Rewards</h3>
